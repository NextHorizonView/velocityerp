// Updated Calendar.tsx with responsive design
...
const Calendar: React.FC<CalendarProps> = ({ selectedTab, setSelectedTab, days }) => (
    <div className="bg-[#576086] mt-6 rounded-lg p-4 lg:p-6">
        <div className="flex justify-between items-center mb-4">
            <div className="flex gap-2 bg-white rounded-full p-1">
                <button
                    className={`px-3 lg:px-4 py-1 rounded-full text-xs lg:text-sm ${
        ...
        <div className="flex justify-between items-center mb-4">
            <h3 className="text-white font-medium text-sm lg:text-base">March 2024</h3>
        ...
        <div className="grid grid-cols-7 gap-1">
            ...
            {days.map((day, index) => (
                <div
                    key={index}
                    className={`text-center py-2 text-xs lg:text-sm rounded-lg ${
                        day === 13 
